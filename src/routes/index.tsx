...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://cosmic-hug-canvas.lovable.app/og-antilope.png" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://cosmic-hug-canvas.lovable.app/og-antilope.png" },
    ],
  }),
  component: Index,
});
